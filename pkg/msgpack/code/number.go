...
const (
	_PrefixPosFixInt = 0b00000000
	_PrefixNegFixInt = 0b11100000
	_PrefixInt8      = 0xd0
	_PrefixInt16     = 0xd1
	_PrefixInt32     = 0xd2
	_PrefixInt64     = 0xd3
...
func IntFunc(v int64) ([]byte, error) {
	...
	// 	if v < 0 {
	// 		return []byte{_PrefixNegFixInt + byte(v)}, nil
	// 	}
	// 	return []byte{_PrefixPosFixInt + byte(v)}, nil
